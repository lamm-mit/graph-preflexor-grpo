...
| `circuit_exp2_redo.py` | Exp 2 redo: mechanism-F1 recovery heatmap |
...
| Late vs control layers (wrong-graph) | +0.290 [+0.233, +0.346] p<0.001 |
| Extractor precision / recall / F1 | 0.689 / 0.515 / 0.567 |

## Models
- Generator: `Qwen/Qwen3-8B`
- Embeddings: `BAAI/bge-base-en-v1.5`
- Platform: NCSA DeltaAI GH200 (n=40 examples)
