"""
eval_qwen_8b_no_thinking.py
Qwen3-8B (no-thinking) — Benchmark Inference Script
...
Description:
    Runs Qwen3-8B (no-thinking) on the 100-question open-ended benchmark
...
Usage:
    ...
    python eval_qwen_8b_no_thinking.py \
        --dataset ../data/benchmark/benchmark_questions.json \
        --outfile ../data/results/qwen_8b_no_thinking_results.jsonl
...
OUTFILE     = "qwen_8b_no_thinking_results_p2.jsonl"
MAX_TOKENS  = 32768
TEMPERATURE = 0.6
TOP_P       = 0.95
TOP_K       = 20
