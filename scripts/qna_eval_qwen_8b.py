...
# ------------------------------------------------------------------------------
MODEL       = "Qwen/Qwen3-8B"
DATASET     = "/home/palsubhadeep/Github/Reasoning_comparison/datasets/research_paper/final_dataset_with_answers_open_question.json"
OUTFILE     = "qna_open_qwen_8B_results.jsonl"
MAX_TOKENS  = 32768
TEMPERATURE = 0.6
TOP_P       = 0.95
TOP_K       = 20
