"""
eval_qwen_1_7b_no_thinking.py
Qwen3-1.7B (no-thinking) — Benchmark Inference Script
...
Description:
    Runs Qwen3-1.7B (no-thinking) on the 100-question open-ended benchmark
...
Usage:
    ...
    python eval_qwen_1_7b_no_thinking.py \
        --dataset ../data/benchmark/benchmark_questions.json \
        --outfile ../data/results/qwen_1_7b_no_thinking_results.jsonl
...
OUTFILE     = "qwen_1_7b_no_thinking_results_p2.jsonl"
MAX_TOKENS  = 32768
TEMPERATURE = 0.6
TOP_P       = 0.95
TOP_K       = 20
...
def evaluate_row(args):
    ...
    return {
        ...
        "llm_output":        get_output(raw_output),
        "error":             error,
